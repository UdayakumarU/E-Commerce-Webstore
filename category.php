...
$cid=intval($_GET['cid']);
$ret = mysql_query("select * from category where id='$cid'");
        ...
        <nav aria-label="breadcrumb">
            ...
            ?>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"><?php echo htmlentities($rw['categoryName']);?></li>
                    </ol>
            <?php 
               } 
            ?>
...
<div class = "container-fluid">
    ...
    <div class = "col-md-12">
     <?php
            $query=mysql_query("select * from products where categoryid='$cid'");
            $num=mysql_num_rows($query);
            if($num==0)
            {?>

                <div class="item  col-xs-2 col-lg-2"> <h3>Coming Soon</h3>
                </div>
        <?php 
             } 
            else 
