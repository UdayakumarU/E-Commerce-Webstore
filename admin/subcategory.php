...
session_start();
	...
	else
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$sql=mysql_query("insert into subcategory(categoryid,subcategoryName,updationDate) values('$category','$subcat','$surrentTime')");
...
<?php $query=mysql_query("select subcategory.id,category.categoryName,subcategory.subcategoryName from subcategory join category on category.id=subcategory.categoryid");
$cnt=1;
while($row=mysql_fetch_array($query))
{
?>									
