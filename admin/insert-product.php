...
$sql=mysql_query("insert into products(categoryid,subCategoryid,productName,productpricebd,offer,productPrice,quantity,productDescription,highlights,shippingCharge,productAvailability,productImage1,productImage2,productImage3,updationDate,rating,salesCount) values('$category','$subcat','$productname','$productpricebd','$offer','$productprice','$quantity','$productdescription','$highlights','$productscharge','$productavailability','$productimage1','$productimage2','$productimage3','$currentTime','$rating','$salesCount')");
if($sql)
...
<div class="controls">
<input type="number"    name="offer"  placeholder="Enter Offer%" class="span8 tip" required>
</div>
</div>
