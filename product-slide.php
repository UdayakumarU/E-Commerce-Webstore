<div id = "productSection" class="card">
    <div class="card-header">
        <h4 class="float-left">Top sales</h4>
        <div id="view-all" class="float-right">
            <a href="top-sales.php?flag=0">
    ...
    <div class="card-body" id = "productSectionBody">
                    <div class ="row">
                        <div id="top-sales" class="owl-carousel owl-theme">
                        <?php
                            $ret=mysql_query("select * from products where salesCount > 0 order by salesCount desc");
